...
|-------------|------|--------------|-------------|-----------------|
| **Student** | Enrolls in beauty training courses; tracks their own learning progress; downloads their certification on completion | Easy course discovery; clear enrollment process; timely schedule access; reliable certificate download | No central platform to browse courses; enrollment via WhatsApp is informal and unreliable; no visibility into training progress; certificates issued slowly and inconsistently | Enrollment completed in under 5 minutes; schedule accessible within 24 hours of enrollment confirmation; certificate available for download within 48 hours of course completion |
| **Trainer** | Delivers training sessions; records student attendance and competency assessments; uploads course materials | Clear visibility of assigned sessions; simple attendance recording interface; ability to upload resources easily | Session assignments communicated informally via WhatsApp; attendance recorded on paper registers; no digital system to track student progress across sessions | All assigned sessions visible on login; attendance recorded digitally for 100% of sessions; course materials uploaded without technical difficulty |
| **Academy Administrator** | Manages the full operational lifecycle — courses, trainers, enrollments, schedules, payments, and certificates | Centralised control of all academy operations; real-time enrollment and payment visibility; reduced manual administrative workload | Hours spent managing spreadsheets for enrollments and scheduling; no payment tracking system; certificate generation is manual and time-consuming | Administrative processing time reduced by at least 50%; all payment records visible on a single dashboard; certificates generated in under 2 minutes |
| **Academy Owner / Principal** | Sets strategic direction; monitors academy growth, revenue, and operational performance | High-level reporting on enrollment numbers, course completion rates, and revenue; assurance that the system is reliable and scalable | No reporting tools available; operational visibility relies entirely on manual updates from staff; no data-driven decision-making capability | Monthly enrollment and revenue reports available on demand; course completion rate trackable at any time; no system downtime during operating hours |
| **IT Support / System Developer** | Deploys, maintains, and updates the platform; ensures system security and availability | Clean, maintainable codebase; clear documentation; containerised deployment; automated backups; predictable system behaviour | Systems often deployed without documentation or deployment guides; no automated backup strategy currently in place | System deployable via Docker Compose in under 30 minutes; API documentation available for all endpoints; automated daily database backups confirmed |
| **Payment Processing Staff** | Reviews uploaded proof of payment (POP) documents; confirms or rejects cash and EFT payments on behalf of the administrator | Clear queue of payments awaiting review; easy access to uploaded POP documents; simple confirm/reject workflow | Payment records tracked in a spreadsheet; POP documents received via WhatsApp and stored inconsistently; no audit trail for confirmed payments | All pending payments visible in a single dashboard view; POP documents accessible with one click; every confirmation logged with timestamp and staff identity |
| **Regulatory / Certification Body** | Sets the professional standards and recognition criteria for beauty industry certifications | Assurance that issued certificates are traceable, verifiable, and consistently formatted; alignment with industry competency standards | No digital verification mechanism for certificates currently issued by the academy; no standardised certificate format | Every certificate contains a unique identifier; certificate metadata stored in the database and retrievable for verification; consistent formatting across all issued certificates |
